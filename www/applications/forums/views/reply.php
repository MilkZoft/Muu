...
?> 
		<div class="newTopic">
			...
			<?php 
				if($action === "save") { 
			?>
					<legend><?php print __(_("New Reply")); ?>
			<?php 
				} else { 
			?>
					<legend><?php print __(_("Edit Reply")); ?>
			<?php 
				} 
			?>
			...
			<p class="field">
				<input id="<?php print $action; ?>" name="doAction" value="<?php print __(_(ucfirst($action))). " ". __(_("reply")); ?>"  type="submit" class="input button" />
				<input id="cancel" name="cancel" value="<?php print __(_("Cancel")); ?>" type="submit" class="input button" />
			</p>
