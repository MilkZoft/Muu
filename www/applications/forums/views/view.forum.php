...
<div class="actions">
	<?php if(SESSION("ZanUserID") > 0) { ?>
		<p class="welcome">
			<?php print __(_("Welcome to the forum")); ?>, <?php print $forum["Forum_Title"]; ?>, <a href="<?php print path("users" . _sh . "editprofile"; ?>" title="<?php print SESSION("ZanUser")); ?>"><?php print SESSION("ZanUser")); ?></a>. <?php print __(_("Feel free of generate new topics")); ?>.
		</p>
		
		<div class="options">
			<ul>
				<li class="main"><?php print __(_("Options")); ?> <span class="little">&rsaquo;&rsaquo;</span></li>
				<li><a href="<?php print path("forums" . _sh . $forum["Forum_Nice"] . _sh . "new"; ?>" title="<?php print __(_("Post a topic")); ?>"><?php print __(_("New topic")); ?></a></li>
				<li><a href="<?php print path("forums" . _sh; ?>" title="<?php print __(_("Back")); ?>!"><?php print __(_("Forums")); ?></a></li>
				<li><a href="<?php print path("users" . _sh . "editprofile" . _sh; ?>" title="<?php print __(_("Edit Profile")); ?>"><?php print __(_("Edit Profile")); ?></a></li>
				<li><a href="<?php print path("users" . _sh . "logout" . _sh . "forums"; ?>" title="<?php print __(_("Logout")); ?>"><?php print __(_("Logout")); ?></a></li>
			</ul>
		</div>
	<?php } else { ?>
		<p class="welcome">
			<?php print __(_("Welcome to the forums of")); ?> <?php print _webName; ?>, <?php print __(_("please login to enjoy the forums or register if you don't have an account")); ?>.
		</p>
		...
		<div class="options">
			<ul>
				<li class="main"><?php print __(_("Options")); ?> <span class="little">&rsaquo;&rsaquo;</span></li>
				<li><a href="<?php print path("forums" . _sh; ?>" title="<?php print __(_("Back")); ?>!"><?php print __(_("Forums")); ?></a></li>
				<li><a class="signIn" href="<?php print path("users" . _sh . "login" . _sh . "forums"); ?>" title="<?php print __(_("Login")); ?>"><?php print __(_("Login")); ?></a></li>
				<li><a class="signUp" href="<?php print path("users" . _sh . "register" . _sh . "forums"); ?>" title="<?php print __(_("Sign up")); ?>"><?php print __(_("Sign up")); ?></a></li>
			</ul>
		</div>
	<?php } ?>
</div>
			...
			if($topics) {
				...
				foreach($topics as $topic) { ?>
					<tr class="rows <?php if($j % 2 === 0) { print "odd"; } else { print "even"; }?>">
						<td class="first">
							<span class="forumTitle">
								<a title="<?php print $topic["Title"]; ?>" href="<?php print path("forums" . _sh . segment(2) . _sh . $topic["ID"]); ?>"><?php print $topic["Title"]; ?></a>
							</span>
							<br />
							<div class="forumDesc"><a title="<?php print $topic["Author"]?>" href="<?php print path("users" . _sh . "profile" . _sh . $topic["Author_ID"]; ?>"><?php print $topic["Author"]?></a></div>
						</td>
						<td class="second">
							...
							<?php } else { ?>
								...
								<span class="postAuthor"> 
									...
									<a title="<?php print $topic["Last_Author"]?>" href="<?php print path("users" . _sh . "profile" . _sh . $topic["Last_Author_ID"]); ?>">
					...
					<?php } elseif(SESSION("ZanUserID")) { ?>
						<td class="fifth">
							<div class="actionbutton"><a href="<?php print $topic["replyURL"]; ?>" title="<?php print __(_("Reply")); ?>" class="ui-icon ui-icon-arrowreturnthick-1-w"></a><span class="hide">Reply</span></div>
							<div class="actionbutton"><a href="<?php print $topic["topicURL"]; ?>" title="<?php print __(_("New topic")); ?>" class="ui-icon ui-icon-plusthick"></a><span class="hide">Topic</span></div>
						</td>
					<?php } ?>
					</tr>
			<?php $j++; 
				...
				<?php if(SESSION("ZanUserID")) { ?>
					<tr class="rows odd">
						<td class="noTopics" colspan="5">
							...
							<a class="newTopic" href="<?php print path("forums" . _sh . $forum["Forum_Nice"] . _sh . "new"); ?>" title="<?php print __(_("Post a topic!")); ?>">
				...
				<?php } else { ?>
					<tr class="rows odd">
						<td class="noTopics" colspan="5">
							...
							<a class="signIn" href="<?php print path("users" . _sh . "login" . _sh . "forums"); ?>" title="<?php print __(_("Login")); ?>">
								<?php print __(_("Login")); ?>
							</a> 
							
							<a class="signUp" href="<?php print path("users" . _sh . "register" . _sh . "forums"); ?>" title="<?php print __(_("Sign up")); ?>">
		...
		<?php if(SESSION("ZanUserID")) { ?>
			<?php if(SESSION("ZanUserPrivilege") === "Super Admin") { ?>
				...
				<ul class="lsprivileges2">
					<li><?php print __(_("You can")); ?> <a href="<?php print path("cpanel" . _sh . "forums" . _sh . "action" . _sh . "save"); ?>" title="<?php print __(_("Create Forums")); ?>"><?php print __(_("create")); ?></a> <?php print __(_("new forums")); ?>.</li>
			...
			<?php } ?>
		<?php } else { ?> 
			<p class="noUserInfo"><?php print __(_("Hi there!, you should")); ?> <a class="signIn" href="<?php print path("users" . _sh . "login" . _sh . "forums"); ?>" title="<?php print __(_("Login")); ?>"><?php print __(_("login")); ?></a> <?php print __(_("to enjoy full access to the forums")); ?>.
				<br /><?php print __(_("If you don't have an account, you can create it")); ?> <a class="signUp" href="<?php print path("users" . _sh . "register" . _sh . "forums"); ?>" title="<?php print __(_("Sign up")); ?>"><?php print __(_("here")); ?></a>.
			</p>
