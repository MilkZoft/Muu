<?php 
	...
	print div("add-form", "class");
		print formOpen($href, "form-add", "form-add");
			...
			print formInput(array("name" => "title", "class" => "input required", "field" => __("Question"), "p" => TRUE, "value" => $title));
			...
			$options = array(
				...
				1 => array("value" => "Multiple", "option" => __("Multiple"), "selected" => ($type === "Inactive") ? TRUE : FALSE)
			);
