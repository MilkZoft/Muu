...
<div class="add-form">
	<form id="form-add" class="form-add" action="<?php print $href; ?>" method="post" enctype="multipart/form-data">
		<fieldset>
			<legend><?php print __(_("Add Video")); ?></legend>
			...
			<?php if($action == "save") { ?>
				...
				<div id="seek">
					<p class="field">
						...
						<p>
							<input type="button" name="inputsearch" id="inputsearch" class="small-submit" value="<?php print __(_("Search"));?>" />
						</p>
					</p>
				</div>
				...
				<div id="videos">
					...
					<?php } else { ?>
						<p class="noresults">
							<?php print __(_("There were no results for this search"));?>
						</p>
					<?php } ?>
				</div>
				...
				<div class="clear"></div>
					...
					<div class="controls">
						...
						<?php if($videos["next"]) { ?>
							<input type="button" name="nextresults" id="nextresults" value="<?php print __(_("Next results"));?>" class="small-submit"/>
						<?php } else { ?>
							<input type="button" name="nextresults" id="nextresults" value="<?php print __(_("Next results"));?>" class="no-display small-submit"/>
						<?php } ?>
...
<?php print $this->js("ajax/search", "videos");?>